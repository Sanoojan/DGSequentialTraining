...
class VisionTransformer(nn.Module):
    ...
    def init_weights(self, mode=''):
        assert mode in ('jax', 'jax_nlhb', 'nlhb','xavier', '')
...
@register_model
def deit_small_patch16_224(pretrained=False,weight_init='', **kwargs):
    """ DeiT-small model @ 224x224 from paper (https://arxiv.org/abs/2012.12877).
    ImageNet-1k weights from https://github.com/facebookresearch/deit.
    """
    model_kwargs = dict(patch_size=16, embed_dim=384, depth=12, num_heads=6,weight_init=weight_init, **kwargs)
