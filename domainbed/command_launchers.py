...
def multi_gpu_launcher_1_2(commands):
    """
    Launch commands on the local machine, using all GPUs in parallel.
    """
    print('WARNING: using experimental multi_gpu_launcher.')
...
def multi_gpu_launcher_1N3(commands):
    """
    Launch commands on the local machine, using all GPUs in parallel.
    """
    print('WARNING: using experimental multi_gpu_launcher.')
    ...
    while len(commands) > 0:
        for gpu_idx in range(n_gpus):
            ...
            if (proc is None) or (proc.poll() is not None):
                ...
                expoo="export"
                new_proc = subprocess.Popen(
                    f'CUDA_VISIBLE_DEVICES={gpu_idx*2+1} {cmd}', shell=True)
                procs_by_gpu[gpu_idx] = new_proc
                break
        time.sleep(1)
...
def multi_gpu_launcher_1_3(commands):
    """
    Launch commands on the local machine, using all GPUs in parallel.
    """
    print('WARNING: using experimental multi_gpu_launcher.')
...
def multi_gpu_launcher_4_5(commands):
    """
    Launch commands on the local machine, using all GPUs in parallel.
    """
    print('WARNING: using experimental multi_gpu_launcher.')
...
def multi_gpu_launcher_5_6(commands):
    """
    Launch commands on the local machine, using all GPUs in parallel.
    """
    print('WARNING: using experimental multi_gpu_launcher.')
    ...
    while len(commands) > 0:
        for gpu_idx in range(n_gpus):
            ...
            if (proc is None) or (proc.poll() is not None):
                ...
                expoo="export"
                new_proc = subprocess.Popen(
                    f'CUDA_VISIBLE_DEVICES={gpu_idx+5} {cmd}', shell=True)
                procs_by_gpu[gpu_idx] = new_proc
                break
        time.sleep(1)
...
def multi_gpu_launcher_5_7(commands):
    """
    Launch commands on the local machine, using all GPUs in parallel.
    """
    print('WARNING: using experimental multi_gpu_launcher.')
...
def multi_gpu_launcher_6_7(commands):
    """
    Launch commands on the local machine, using all GPUs in parallel.
    """
    print('WARNING: using experimental multi_gpu_launcher.')
    ...
    while len(commands) > 0:
        for gpu_idx in range(n_gpus):
            ...
            if (proc is None) or (proc.poll() is not None):
                ...
                expoo="export"
                new_proc = subprocess.Popen(
                    f'CUDA_VISIBLE_DEVICES={gpu_idx+6} {cmd}', shell=True)
                procs_by_gpu[gpu_idx] = new_proc
                break
        time.sleep(1)
...
def multi_gpu_launcher_4_7(commands):
    """
    Launch commands on the local machine, using all GPUs in parallel.
    """
    print('WARNING: using experimental multi_gpu_launcher.')
...
def multi_gpu_launcher_0_3(commands):
    """
    Launch commands on the local machine, using all GPUs in parallel.
    """
    print('WARNING: using experimental multi_gpu_launcher.')
...
def multi_gpu_launcher_0_2(commands):
    """
    Launch commands on the local machine, using all GPUs in parallel.
    """
    print('WARNING: using experimental multi_gpu_launcher.')
...
def multi_gpu_launcher_0_5(commands):
    """
    Launch commands on the local machine, using all GPUs in parallel.
    """
    print('WARNING: using experimental multi_gpu_launcher.')
...
REGISTRY = {
    ...
    'multi_gpu_1_2':multi_gpu_launcher_1_2,
    'multi_gpu_2_3':multi_gpu_launcher_2_3,
    'multi_gpu_1_3':multi_gpu_launcher_1_3,
    'multi_gpu_1N3':multi_gpu_launcher_1N3,
    'multi_gpu_0_1':multi_gpu_launcher_0_1,
    'multi_gpu_4_5':multi_gpu_launcher_4_5,
    'multi_gpu_5_6':multi_gpu_launcher_5_6,
    'multi_gpu_5_7':multi_gpu_launcher_5_7,
    'multi_gpu_6_7':multi_gpu_launcher_6_7,
    'multi_gpu_4_7':multi_gpu_launcher_4_7,
    ...
    'gpu_5':gpu_launcher_5,
    'gpu_6':gpu_launcher_6,
}
