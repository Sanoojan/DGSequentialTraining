...
def _hparams(algorithm, dataset, random_seed):
    ...
    _hparam('noise_probability',0.0,lambda r: r.choice([0., 0.1, 0.5,1.0]))
    ...
    elif algorithm in ["DPLCLIP","ERM_clip_WTC_DPL","ERM_clip_WTC_DPL_single_net","DPLCLIP_mixup_with_text","DPLCLIP_mixup_with_text_nofrz","ERM_clip_cross_attn"]:
    ...
    elif algorithm == "Mixup" or algorithm == "Manifold_Mixup" or algorithm=="Mixup_with_text":
    ...
    if dataset in SMALL_IMAGES or algorithm in ["DPLCLIP","DPLCLIP_mixup_with_text","DPLCLIP_mixup_with_text_nofrz"]:  # DPLCLIP using SGD follower prior work.
        _hparam('lr', 1e-3, lambda r: 10**r.uniform(-4.5, -2.5))
    else:
        _hparam('lr', 5e-5, lambda r: 10**r.uniform(-5, -3.5))

    if dataset in SMALL_IMAGES or algorithm in ["DPLCLIP","ERM_clip_WTC_DPL","ERM_clip_WTC_DPL_single_net","DPLCLIP_mixup_with_text","DPLCLIP_mixup_with_text_nofrz"]:
