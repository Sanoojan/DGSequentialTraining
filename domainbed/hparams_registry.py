...
def _hparams(algorithm, dataset, random_seed):
    ...
    elif algorithm in ["DPLCLIP","ERM_clip_WTC_DPL","ERM_clip_WTC_DPL_single_net","DPLCLIP_mixup_with_text","ERM_clip_WTC_DPL_no_conf","ERM_clip_cross_attn"]:
    ...
    if dataset in SMALL_IMAGES or algorithm in ["DPLCLIP","DPLCLIP_mixup_with_text"]:  # DPLCLIP using SGD follower prior work.
        _hparam('lr', 1e-3, lambda r: 10**r.uniform(-4.5, -2.5))
    else:
        _hparam('lr', 5e-5, lambda r: 10**r.uniform(-5, -3.5))

    if dataset in SMALL_IMAGES or algorithm in ["DPLCLIP","ERM_clip_WTC_DPL","ERM_clip_WTC_DPL_single_net","DPLCLIP_mixup_with_text","ERM_clip_WTC_DPL_no_conf"]:
